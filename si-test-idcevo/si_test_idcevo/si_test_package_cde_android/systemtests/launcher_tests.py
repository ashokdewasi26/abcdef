...
from si_test_idcevo.si_test_helpers.pages.cde.launcher_page import LauncherPage as Launcher
...
class TestLauncher:
    ...
    def test_002_check_go_back_to_home(self):
        ...
        assert_true(
            Launcher.validate_activity(
                list_activities=["com.bmwgroup.apinext.cdelauncherapp/.presentation.ui.MainActivity"]
            ),
