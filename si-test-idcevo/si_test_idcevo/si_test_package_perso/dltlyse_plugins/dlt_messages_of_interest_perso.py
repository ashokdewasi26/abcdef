...
class DLTMsgInterestPersoPlugin(DLTMsgInterestPlugin):
    ...
    **Output Files**
    ...
    def __init__(self):
        resources_path = configs_path / "data/dlt_list_of_interest_perso.csv"
        if not os.path.exists(resources_path):
            traas_path = Path("/ws/repos/si-test-idcevo/si_test_idcevo/si_test_package_demo/dltlyse_plugins/data")
            resources_path = traas_path / "dlt_list_of_interest_perso.csv"
        super().__init__(
            list_of_interest_path=[resources_path],
            msgs_of_interest_file="dlt_msgs_interest_perso.csv",
            general_csv=True,
