...
class LauncherPage(BasePage):
    PACKAGE_NAME = "com.bmwgroup.apinext.rselauncherapp"
    LAUNCHER_RESOURCE_ID_PREFIX = PACKAGE_NAME + ":id/"
    PACKAGE_ACTIVITY = ".MainActivity"
    # Launcher elements resource ID / locators
    ALL_APPS_RIGHT_BUTTON_ID = Element(By.XPATH, "//*[@resource-id='OpenAllAppsRIGHT_SIDE']")
    ALL_APPS_MENU_ID = Element(By.XPATH, "//*[contains(@resource-id,'allapps_menucomponent_prefix')]")
    HOME_BUTTON_ID = Element(By.XPATH, "//*[@resource-id='GoHomeLEFT_SIDE']")
    HOME_MENU_ID = Element(By.XPATH, "//*[@resource-id='RowHomeScreen']")
    ...
    def press_all_apps_button(cls):
        ...
        """
        all_apps_button = cls.check_visibility_of_element(cls.ALL_APPS_RIGHT_BUTTON_ID)
