...
from si_test_apinext.idc23.pages.deskclock_page import DeskclockPage as Deskclock
...
class TestLauncher:
    ...
    def teardown_class(cls):
        utils.stop_recording(cls.test, "Launcher_tests")
    ...
    @skip("Buttons are not available on the new IDC launcher")
    @utils.gather_info_on_fail
    def test_001_check_main_menu_bar_contents_on_bmw_launcher(self):
        ...
        *Steps*
        ...
        GlobalSteps.click_button_and_expect_elem(self.test.wb, media_button, Media.MEDIA_BAR_ID)
        Launcher.go_to_home()
    ...
    def test_003_check_bmw_launcher_widgets_are_clickable(self):
        ...
        *Steps*
        ...
        try:
            ...
            GlobalSteps.click_button_and_expect_elem(self.test.wb, media_widget, Media.MEDIA_BAR_ID)
            Launcher.go_to_home()
    ...
    def test_004_check_all_apps_menu_search_for_an_available_app(self):
        ...
        *Steps*
        ...
        5. Type an available app,e.g: App Store
        6. On Results list should only be "App Store" app
        ...
        displayed_apps = GlobalSteps.input_text_and_get_elements(
            self.test.driver, edit_text, search_app, Launcher.SEARCH_RESULT_APP_TEXT_ID
        )
        # Waiting for "App Store" app to appear beside search bar
        time.sleep(1)
        ...
        GlobalSteps.click_button_and_expect_elem(self.test.wb, back_arrow_button, Launcher.ALL_APPS_SEARCH_LABEL_ID)
    ...
    def test_005_check_all_apps_menu_search_for_an_unavailable_app(self):
        ...
        *Background information*
        ...
        Precondition: App should not be available on Menu
        ...
        *Steps*
        ...
        displayed_apps = GlobalSteps.input_text_and_get_elements(
            self.test.driver, edit_text, "Unavailable App", Launcher.SEARCH_RESULT_APP_TEXT_ID
        )
        back_arrow_button = self.test.driver.find_element(*Launcher.BACK_ARROW_BUTTON_ID)
        GlobalSteps.click_button_and_expect_elem(self.test.wb, back_arrow_button, Launcher.ALL_APPS_SEARCH_LABEL_ID)
    ...
    def test_006_check_all_apps_menu_search_for_relevant_matches(self):
        ...
        *Steps*
        ...
        6. On Results list should be all apps that have vehicle on their names
            Expecting apps: Live Vehicle and Vehicle Statuss

        """
        search_text = "vehicle"
        edit_text = Launcher.open_all_apps_search_from_home()
        edit_text.send_keys(search_text)
        # Waiting for all the vehicle related Apps to appear on the left side.
        time.sleep(2)
        ...
        while True:
            results_text_elem = self.test.driver.find_elements(*Launcher.SEARCH_RESULT_APP_TEXT_ID)
    ...
    def test_007_check_go_back_to_home(self):
        ...
        *Steps*
        ...
        """
        Launcher.go_to_home()
        search_label = Launcher.press_all_apps_button()
        search_label.click()
        back_arrow_button = self.test.driver.find_element(*Launcher.BACK_ARROW_BUTTON_ID)
        GlobalSteps.click_button_and_expect_elem(self.test.wb, back_arrow_button, Launcher.ALL_APPS_SEARCH_LABEL_ID)
        back_arrow_button = self.test.driver.find_element(*Launcher.BACK_ARROW_BUTTON_ID)
