...
class TestKinematicsPADI:
    ...
    def setup_class(cls):
        ...
        # Wait for 2 second for the PADI starting animation to finish.
        time.sleep(2)
    ...
    def test_001_check_padi_kinematics_status(self):
        ...
        **Steps**
            ...
            3. Fulfill pre-requisites place angle 90 degrees and cinemaposition
        ...
        **Expected outcome**
        ...
        touch_positions = 2, 4
        # angles of cinema position [90,45,30] (list-for reverse functionality)
    ...
    def test_003_check_padi_kinematics_popup_childlock(self):
        ...
        **Expected outcome**
        ...
        popup_text = (
            ("无法调整全景娱乐屏。请检查儿童锁。",)
            if self.test.mtee_target.hardware_variant == "padi_china"
            else (
