...
class TestLauncherRebootPADI:
    ...
    def check_dlt_context(self, dlt_msg, max_wait, name, drop=False, count=1, raise_on_timeout=True, reboot=False):
        ...
        param: name: name for for B2B connection or CE area content
    ...
    def test_002_check_b2b_connection(self):
        ...
        1. In this test we expect the CE area content to be established in between 15 and 90 sec
        ...
        *Steps*
        1. reboot the target
        2. check the CE Area content dlt payload with "apid":"ALD", "ctid":"LCAT" it should arrive between 15-90 sec.
        3. validate time stamps does it arrived between 15-90 seconds else raise MteeTimeoutError
        ...
        ce_content_message = (
            r"BRSS\|AnimationManager\[*[\d]*\]:\ allBootConditionsMet stopping boot animation "
